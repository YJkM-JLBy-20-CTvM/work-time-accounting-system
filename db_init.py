...
cur.execute("SELECT COUNT(*) FROM employees WHERE employee_role = 'admin';")
...
if not admin_exists:
    ...
    """, (hashed_password, department_id, position_id))

    print("Создан начальный администратор (admin / 12345)")
